import argparse
from data_req import load_data
import model_req
...
model = model_req.build_network(network_architecture, hidden_units)
model.class_to_idx = train_data.class_to_idx

model, criterion = model_req.train_network(model, epochs, learning_rate, trainloader, validloader, gpu)
model_req.evaluate_model(model, testloader, criterion, gpu)
model_req.save_model(model, network_architecture, hidden_units, epochs, learning_rate, save_dir)
